 ...
 */
import type { Coord, MapType, Terrain, Tile } from "@polytopia/shared";
export interface GeneratedMap {
    tiles: Tile[];
    /** Cases de départ (futures capitales), une par joueur. */
    starts: Coord[];
}
export declare function mapSizeForPlayers(count: number, mapType?: MapType): number;
...
export declare function generateMap(seed: number, width: number, height: number, playerCount: number, mapType?: MapType): GeneratedMap;
