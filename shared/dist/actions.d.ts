 ...
 */
import type { CityReward, Coord, PlayerId, UnitType } from "./types.js";
...
export type Action = MoveUnitAction | AttackAction | FoundCityAction | CaptureCityAction | TrainUnitAction | ResearchTechAction | HarvestResourceAction | BuildImprovementAction | ClaimCityRewardAction | EndTurnAction;
